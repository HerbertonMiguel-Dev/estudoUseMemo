import React, { useState, useEffect, useMemo } from "react"; // Importa React e hooks useState, useEffect e useMemo para gerenciamento de estado e efeitos colaterais
import { View, StyleSheet, Text, TextInput, TouchableOpacity } from "react-native"; // Importa componentes de layout e estilização do React Native
